const Services = () => {
    return ( 
        ...
        <h1 className="text-4xl font-bold text-center mb-12 animate-fade-in">My Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-300 hover:scale-105 animate-fade-in">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-red-800 dark:text-indigo-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
